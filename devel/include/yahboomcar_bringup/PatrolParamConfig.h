...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(PatrolParamConfig::AbstractParamDescriptionConstPtr(new PatrolParamConfig::ParamDescription<int>("Command", "int", 0, "A size parameter which is edited via an enum", "{'enum': [{'name': 'LengthTest', 'type': 'int', 'value': 0, 'srcline': 18, 'srcfile': '/root/yahboomcar_ws/src/yahboomcar_bringup/cfg/PatrolParam.cfg', 'description': 'first data', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'AngleTest', 'type': 'int', 'value': 1, 'srcline': 19, 'srcfile': '/root/yahboomcar_ws/src/yahboomcar_bringup/cfg/PatrolParam.cfg', 'description': 'two data', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Triangle', 'type': 'int', 'value': 2, 'srcline': 20, 'srcfile': '/root/yahboomcar_ws/src/yahboomcar_bringup/cfg/PatrolParam.cfg', 'description': 'three datat', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Square', 'type': 'int', 'value': 3, 'srcline': 21, 'srcfile': '/root/yahboomcar_ws/src/yahboomcar_bringup/cfg/PatrolParam.cfg', 'description': 'four data', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Circle', 'type': 'int', 'value': 4, 'srcline': 22, 'srcfile': '/root/yahboomcar_ws/src/yahboomcar_bringup/cfg/PatrolParam.cfg', 'description': 'five data', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Parallelogram', 'type': 'int', 'value': 5, 'srcline': 23, 'srcfile': '/root/yahboomcar_ws/src/yahboomcar_bringup/cfg/PatrolParam.cfg', 'description': 'six data', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'An enum to set size'}", &PatrolParamConfig::Command)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 18 "/root/yahboomcar_ws/src/yahboomcar_bringup/cfg/PatrolParam.cfg"
      const int PatrolParam_LengthTest = 0;
//#line 19 "/root/yahboomcar_ws/src/yahboomcar_bringup/cfg/PatrolParam.cfg"
      const int PatrolParam_AngleTest = 1;
//#line 20 "/root/yahboomcar_ws/src/yahboomcar_bringup/cfg/PatrolParam.cfg"
      const int PatrolParam_Triangle = 2;
//#line 21 "/root/yahboomcar_ws/src/yahboomcar_bringup/cfg/PatrolParam.cfg"
      const int PatrolParam_Square = 3;
//#line 22 "/root/yahboomcar_ws/src/yahboomcar_bringup/cfg/PatrolParam.cfg"
      const int PatrolParam_Circle = 4;
//#line 23 "/root/yahboomcar_ws/src/yahboomcar_bringup/cfg/PatrolParam.cfg"
